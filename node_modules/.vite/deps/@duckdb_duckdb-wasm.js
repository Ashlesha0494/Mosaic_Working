...
var TypeAssembler = class extends Visitor {
  ...
  visitDuration(node, b2) {
    Duration2.startDuration(b2);
    Duration2.addUnit(b2, node.unit);
    return Duration2.endDuration(b2);
  }
  visitList(_node, b2) {
    List2.startList(b2);
...
var h = null;
async function de() {
  return k == null && (k = typeof BigInt64Array < "u"), y == null && (y = await f()), g == null && (g = await C()), S == null && (S = await U()), h == null && (h = await F()), { bigInt64Array: k, crossOriginIsolated: M() || globalThis.crossOriginIsolated || false, wasmExceptions: y, wasmSIMD: S, wasmThreads: g, wasmBulkMemory: h };
}
async function xe(s) {
  let e = await de();
  if (e.wasmExceptions) {
...
export {
  ...
  Ue as PACKAGE_VERSION_MINOR,
  Ce as PACKAGE_VERSION_PATCH,
  ne as StatusCode,
  X as TokenType,
  A as VoidLogger,
  ...
  me as getLogEventLabel,
  pe as getLogLevelLabel,
  _e2 as getLogOriginLabel,
